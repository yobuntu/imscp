...
<table class="firstColFixed">
	...
	<tr>
		...
		<td colspan="2">
			<input type="password" name="password_confirmation" id="password_confirmation" value="{PASSWORD_CONFIRMATION}" autocomplete="off"/>
		</td>
	</tr>
	<tr>
		...
		<td colspan="3" id="dialogContainer" style="height: 30px;">
			...
			<div style="margin:0" id="php_editor_dialog" title="{TR_PHP_EDITOR_SETTINGS}">
				...
				<table>
					...
					<tr>
						<td>
							{TR_PHP_INI_AL_ALLOW_URL_FOPEN}<span class="permission_help icon i_help" title="{TR_PHP_INI_PERMISSION_HELP}">{TR_HELP}</span>
						</td>
						<td>
							<div class="ui-buttonset">
					...
					<tr>
						<td>
							{TR_PHP_INI_AL_DISPLAY_ERRORS}<span class="permission_help icon i_help" title="{TR_PHP_INI_PERMISSION_HELP}">{TR_HELP}</span>
						</td>
						<td>
							<div class="ui-buttonset">
					...
					<tr>
						<td>
							{TR_PHP_INI_AL_DISABLE_FUNCTIONS}<span class="permission_help icon i_help" title="{TR_PHP_INI_PERMISSION_HELP}">{TR_HELP}</span>
						</td>
						<td>
							<div class="ui-buttonset">
					...
					<tr>
						<td>
							<label for="php_ini_max_post_max_size">{TR_PHP_INI_MAX_POST_MAX_SIZE}</label>
						</td>
						<td>
					...
					<tr>
						<td>
							<label for="php_ini_max_upload_max_filesize">{TR_PHP_INI_MAX_UPLOAD_MAX_FILESIZE}</label>
						</td>
						<td>
