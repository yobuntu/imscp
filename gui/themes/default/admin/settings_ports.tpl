...
<form name="editFrm" method="post" action="settings_ports.php" onsubmit="return enable_for_post();">
	<table>
		...
		<tr>
			...
			<td><input name="ip[]" type="text" id="ip{NUM}" value="{IP}" maxlength="15" {PORT_READONLY} /></td>
			<td><input name="port[]" type="text" id="port{NUM}" value="{PORT}" maxlength="5" {PORT_READONLY} /></td>
			<td>
