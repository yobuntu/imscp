<table>
	...
	<tr>
		<td>
			<p>
				<span class="bold">{TR_USER_NAME}</span> - <a href="imscp_debugger.php?action=change_status&amp;id={CHANGE_ID}&amp;type={CHANGE_TYPE}" class="link">{TR_CHANGE_STATUS}</a>
			</p>
...
<table>
	...
	<tr>
		<td>
			<span class="bold">{TR_ALS_NAME}</span> - <a href="imscp_debugger.php?action=change_status&amp;id={CHANGE_ID}&amp;type={CHANGE_TYPE}" class="link">{TR_CHANGE_STATUS}</a>
...
<table>
	...
	<tr>
		<td>
			<p>
				<span class="bold">{TR_SUB_NAME}</span> - <a href="imscp_debugger.php?action=change_status&amp;id={CHANGE_ID}&amp;type={CHANGE_TYPE}" class="link">{TR_CHANGE_STATUS}</a>
			</p>
...
<table>
	...
	<tr>
		<td>
			<p>
				<span class="bold">{TR_ALSSUB_NAME}</span> - <a href="imscp_debugger.php?action=change_status&amp;id={CHANGE_ID}&amp;type={CHANGE_TYPE}" class="link">{TR_CHANGE_STATUS}</a>
			</p>
...
<table>
	...
	<tr>
		<td>
			<p>
				<span class="bold">{TR_HTACCESS_NAME}</span> - <a href="imscp_debugger.php?action=change_status&amp;id={CHANGE_ID}&amp;type={CHANGE_TYPE}" class="link">{TR_CHANGE_STATUS}</a>
			</p>
...
<table>
	...
	<tr>
		<td>
			<p>
				<span class="bold">{TR_PLUGIN_NAME}</span> - <a href="imscp_debugger.php?action=change_status&amp;id={CHANGE_ID}&amp;type={CHANGE_TYPE}" class="link">{TR_CHANGE_STATUS}</a>
			</p>
