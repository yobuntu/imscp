...
<table>
	...
	<tr>
		...
		<td>{TR_RESELLER}</td>
		<td align="center">
			<a href="{IMPORT_LINK}" class="icon i_app_download" onClick="return action_import()">{TR_IMPORT}</a>
		</td>
		<td align="center">
			<a href="{DOWNLOAD_LINK}" class="icon i_app_download" target="_blank">{TR_DOWNLOAD}</a></td>
		<td align="center">
			<a href="{ACTIVATE_LINK}" class="icon i_edit" onClick="return action_activate()">{TR_ACTIVATION}</a>
		</td>
		<td align="center">
			<a href="{DELETE_LINK}" class="icon i_delete" onClick="return action_delete()">{TR_DELETE}</a>
		</td>
	</tr>
	<!-- EDP: list_software -->
	<tr>
...
<table>
	...
	<tr>
		...
		<td align="center" width="100">
			<a href="software_reseller.php?id={RESELLER_ID}">{RESELLER_SOFTWARE_IN_USE}</a>
		</td>
	</tr>
	<!-- EDP: list_reseller -->
	<tr>
