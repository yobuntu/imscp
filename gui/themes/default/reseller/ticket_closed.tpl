...
<table>
	...
	<tr>
		...
		<td>
			...
			<a href="ticket_view.php?ticket_id={TICKET_ID_VAL}" class="link" title="{TR_TICKET_READ_LINK}">{TICKET_SUBJECT_VAL}</a>
		</td>
		...
		<td>
			...
			<a href="#" onclick="return action_delete('ticket_delete.php?ticket_id={TICKET_ID_VAL}', '{TICKET_SUBJECT2_VAL}')" class="link" title="{TR_TICKET_DELETE_LINK}">{TR_TICKET_DELETE}</a>
			<img src="{THEME_COLOR_PATH}/images/icons/open.png" style="vertical-align:middle;" alt=""/>&nbsp;
			<a href="ticket_closed.php?ticket_id={TICKET_ID_VAL}" class="link" title="{TR_TICKET_REOPEN_LINK}">{TR_TICKET_REOPEN}</a>
		</td>
	</tr>
	<!-- EDP: tickets_item -->
	<tr>
