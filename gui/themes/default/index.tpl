	...
	<div id="loginBox">
		<form name="loginFrm" action="index.php" method="post">
			<label for="uname">
				...
				<input type="text" name="uname" id="uname" tabindex="1" value="{UNAME}"/>
			</label>
			<label for="upass">
				<span>{TR_PASSWORD}</span>
...
<div id="toolbox">
	<ul>
		...
		<li>
			<a class="icon_big webmail" href="{TR_WEBMAIL_LINK}" target="blank" title="{TR_LOGIN_INTO_WEBMAIL}">{TR_WEBMAIL}</a>
		</li>
	</ul>
</div>
