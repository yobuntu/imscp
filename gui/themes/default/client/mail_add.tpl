...
<form name="client_mail_add" action="mail_add.php" method="post" id="client_mail_add">
	<table>
		...
		<tr>
			<td colspan="2">
				<input type="checkbox" name="mail_type_normal" value="1" onclick="changeType();" {NORMAL_MAIL_CHECKED} />{TR_NORMAL_MAIL}
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2">
				<input type="checkbox" name="mail_type_forward" value="1" {FORWARD_MAIL_CHECKED} onclick="changeType();"/>{TR_FORWARD_MAIL}
			</td>
		</tr>
		<tr>
			<td>
