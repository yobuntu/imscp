...
class iMSCP_Update_Database extends iMSCP_Update
{
	...
	protected function _databaseUpdate_113(){
	 ...
	 /**
         * #451: Enhancement - Integrate pwik into i-mscp
         *
		...
		return array(
			//#FIXME (here should be PIWIK_DATABASE instead of hardcoded name
			"CREATE DATABASE IF NOT EXISTS `imspcp_piwik` CHARACTER SET utf8 COLLATE utf8_unicode_ci",
			"USE imscp_piwik",
